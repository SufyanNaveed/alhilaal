...
class ZATCASimplifiedTaxInvoice
{
    ...
    {
        $populated_template = require dirname(__DIR__) . '/src/templates/simplified_tax_invoice_template.php';
    ...
    {
        $populated_template = require dirname(__DIR__) . '/src/templates/invoice_billing_reference_template.php';
    ...
    {
        $populated_template = require dirname(__DIR__) . '/src/templates/ubl_signature_signed_properties_for_signing_template.php';
    ...
    {
        $populated_template = require dirname(__DIR__) . '/src/templates/ubl_signature_signed_properties_template.php';
    ...
    public function defaultUBLExtensions(string $invoice_hash, string $signed_properties_hash, string $digital_signature, string $cleanUpCertificateString, string $ubl_signature_signed_properties_xml_string): string
    {
        ...
        $populated_template = require dirname(__DIR__) . '/src/templates/ubl_signature.php';
...
//        }
         ...
         * set invoice lines
         */
        $tax_total_template = require dirname(__DIR__) . '/src/templates/tax_total_template.php';
         ...
         */
        $legal_monetary_total_template = require dirname(__DIR__) . '/src/templates/legal_monetary_total_template.php';
         ...
         * set invoice lines
         */
        $invoice_line_template = require_once dirname(__DIR__) . '/src/templates/invoice_line_template.php';
